...
import { Resource, Address, EdCeo, Contact } from "../../types/ResourceObject";
...
const ResourcePage = () => {
  ...
  const handleAddResource = () => {
    ...
    const primaryCategoryInput = prompt(
      "Enter primary category for the resource:"
    );
            ...
            return (
              <tr key={index}>
                ...
                <td className={styles.dataRow}>
                  {resourceObject.physicalAddress.city},{" "}
                  {resourceObject.physicalAddress.state},{" "}
                  {resourceObject.physicalAddress.zip}
                </td>
                <td className={styles.dataRow}>
                  {resourceObject.primaryCategory}
                </td>
